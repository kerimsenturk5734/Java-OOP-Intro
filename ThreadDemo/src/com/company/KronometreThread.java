...
public class KronometreThread implements Runnable{//Bütün threadler Runnable interface ni implement eder.

   private Thread thread;
   private String threadName;

   public KronometreThread(String threadName){//Threadlerin bir ismi olmalıdır.Bu isim sayesinde sistem tarafından ayırt edilebilirler
